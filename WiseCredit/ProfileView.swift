        ...
        NavigationView {
            ZStack {
                ...
                VStack(spacing: 30) {
                    ...
                    VStack {
                        Image("profile_picture")  // Imagen del perfil
                            .resizable()
                            .scaledToFit()
                            .clipShape(Circle())
                    ...
                    .padding(.top, 80)  // Aumenta el padding superior para evitar que la imagen se superponga al Toolbar
                    ...
                    .padding(.bottom, 50)  // Mantén este padding para separar el botón del borde inferior
                }
